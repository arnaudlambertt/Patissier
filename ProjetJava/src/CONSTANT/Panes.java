...
public class Panes
{
    ...
    public static final int BOUTONS_CATEGORIES_WIDTH_OFFSET_PANE_ENTETE=21;
    public static final int SEPARATOR_VERTICAL_HEIGHT_PANE_ENTETE=26;

    //  SCENE CONNEXION
    public static final int SIZE_TEXTFIELD_SCENE_CONNEXION=300;
    public static final int GRID_HGAP_SCENE_CONNEXION=100;
    
    // SCENE CREATION COMPTE
    public static final int LABEL_WIDTH_SCENE_CREATION_COMPTE=90;
    public static final int TEXTFIELD_WIDTH_SCENE_CREATION_COMPTE=300;
    
    // SCENE PANIER
    public static final int VGAP_SCENE_PANIER=10;
    
    // SCENE PRODUITS
    
    public static final int VGAP_SCENE_PRODUITS = 25;
}
